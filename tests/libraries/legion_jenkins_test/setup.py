...
setup(name='legion_jenkins_test',
      version=extract_version(os.path.join(PACKAGE_ROOT_PATH, 'legion_jenkins_test', 'version.py')),
      description='Legion CI tools',
      url='http://github.com/legion-platform/legion-jenkins',
